...
def minimax_ab(board,depth,alpha,beta,maximizingPlayer):
    ...
    if maximizingPlayer:
        value =-math.inf
        coulmn=random.choice(valid_locations)
...
# difficulty_depth = show_difficulty_menu()
# selected_agent = show_agent_selection_menu()
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if turn == AI and not game_over:	
                ...
                col,minimax_score=minimax_ab(board,5,-math.inf,math.inf,True)
